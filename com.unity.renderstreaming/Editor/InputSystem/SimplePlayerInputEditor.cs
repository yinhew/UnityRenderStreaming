...
namespace UnityEngine.RenderStreaming.Editor
{
    ...
    internal class SimplePlayerInputEditor : UnityEditor.Editor
    {
        ...
        private void DoDebugUI()
        {
            ...
            m_DevicesGroupUnfolded = EditorGUILayout.Foldout(m_DevicesGroupUnfolded, m_DevicesGroupText, toggleOnLabelClick: true);
        ...
        private readonly GUIContent m_DevicesGroupText =
            EditorGUIUtility.TrTextContent("Devices", "InputDevices paired by the PlayerInput component");
